...
**Drawback das 3 Habilidades de +Mana:** Gnomos das Minas, Soldados de Camelot e Zumbis Errantes ganham Mana (2, 2 e 3 respectivamente — 1 a mais que o próprio Custo de Habilidade cobra, pra sobrar +1 líquido de verdade), mas cada ativação também custa **descartar 1 carta da mão OU destruir 1 Maldição virada para baixo sua, à escolha do jogador** — nunca uma carta do oponente, é um preço pago com o próprio recurso, mesmo espírito do sacrifício dos Encantamentos Contínuos. Sem carta na mão nem Maldição setada pra sacrificar, a Habilidade segue sem esse custo extra (mesma leniência de Pacto de Sangue/Selva Amazônica quando falta o alvo do sacrifício).
